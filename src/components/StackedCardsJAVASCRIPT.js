...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    function stackedCards() {
        ...
        function transformUi(moveX, moveY, opacity, elementObj) {
            // requestAnimationFrame is a function that would ensure that the animation code is run when the user's computer is ready. Thus improving performance by slowing down or pausing the code when it is running in a background tab.
